...
START_BUTTONS=[
    [
        InlineKeyboardButton('ɢʀᴏᴜᴘ', url='https://t.me/+AytqFgvWXdhjYmUy'),
        InlineKeyboardButton('ᴄʜᴀɴɴᴇʟ', url='https://t.me/Flater'),
    ],
    [InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://t.me/rzzrrrr)],
]

DL_BUTTONS=[
    [
        InlineKeyboardButton('not-mark', callback_data='nowm'),
        InlineKeyboardButton('mark', callback_data='wm'),
    ],
...
async def _start(bot, update):
  await update.reply_text(f"Welcome dear I download bot from tuk tuk choose the download type 
not-mark or 
mark", True, reply_markup=InlineKeyboardMarkup(START_BUTTONS))
